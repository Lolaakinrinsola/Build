    ...
    <div className='flex flex-col justify-center'>
        <div className='grid justify-center  gap-[3em] lg:space-y-0 lg:grid-cols-4 md:grid-cols-2 py-[4em] px-[2em] lg:px-[10em] m-auto '>
            <div className='gap-[3em] '>
                ...
                <ul>
                    <Link to='/About'><li className='text-white-30 p3'>About Us</li></Link>
                    <Link to='/contact'><li className='text-white-30 p3'>Contact</li></Link>
                    <Link><li className='text-white-30 p3'>Partners</li></Link>
                    <Link to='/stories'><li className='text-white-30 p3'>Blog</li></Link>
                </ul>
            </div>
            <div className='space-y-3'>
                <p className='text-secondary-10 p3'>Products</p>
                <ul>
                <Link><li className='text-white-30 p3'>Personal Accounts</li></Link>
                <Link><li className='text-white-30 p3'>Build for business</li></Link>
                </ul>
            </div>
            <div className='space-y-3'>
                <p className='text-secondary-10 p3'>Resources</p>
                <ul>
                <Link><li className='text-white-30 p3'>Help Center</li></Link>
                <Link><li className='text-white-30 p3'>Privacy Policy</li></Link>
                <Link to='/FAQs' ><li className='text-white-30 p3'>FAQs</li></Link>
                </ul>
            </div>
            <div className='space-y-3'>
        ...
        <div className='flex flex-col space-y-5 md:space-y-0 lg:flex-row gap-[1em] justify-between mx-[2em] lg:mx-[10em] border-t border-white-30 py-[4em] items-center'>
            <div>
